...
namespace Offsets {
	...
	BOOLEAN Initialize() {
		...
		Engine::SceneComponent::ComponentVelocity = 0x140; //0x140
		Engine::StaticMeshComponent::StaticMesh = 0x468; //80 // 0x480 // working 0x468
		Engine::SkinnedMeshComponent::CachedWorldSpaceBounds = 0x600;
		FortniteGame::FortPawn::bIsDBNO = 0x552; //maybe 0x2BE
		FortniteGame::FortPawn::bIsDying = 0x538; // 0x538
		FortniteGame::FortPlayerStateAthena::TeamIndex = 0xe68; //0xe68
		FortniteGame::FortPickup::PrimaryPickupItemEntry = 0x298; //0x298
		FortniteGame::FortItemDefinition::DisplayName = 0x70; //0x70
		FortniteGame::FortItemDefinition::Tier = 0x54; //0x54
